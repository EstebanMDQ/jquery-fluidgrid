...
(function($) {
	$.fn.fluidGrid = function(options) {
		...
		if(typeof(this.length)=="undefined" || this.length==0) {
			console.log('no fluid grids in the page');
			return false;
		}
		...
		console.log("container width "+$(this).width()+ " calculated "+((iw + gu)*cc)+ " iw:"+iw);
		...
		console.log(iw, gu, cc, coffset, loffset, fcols);
